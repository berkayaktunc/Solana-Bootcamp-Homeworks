...
contract HomeworkOne {
    ...
    // Returning the description value of our counter.
    // "memory" is required when we return string.
    // "calldata" is required if the returned value is array.
    function get_counter_desctiption() external view returns(string memory) {
